...
class MediaListPlayer(_Ctype):
    ...
    def next(self):
        ...
        '''
        self.playlistId += 1
        if self.playlistId >= self.playlistLen:
            self.playlistId = self.playlistLen-1#0
            return play_item_at_index(self, self.playlistId)
        #return play_item_at_index(self, self.playlistId)
    ...
    def previous(self):
        ...
        if self.playlistId < 0:
            self.playlistId = 0#selp.playlistLen-1
            return play_item_at_index(self, self.playlistId)
        #return play_item_at_index(self, self.playlistId)
