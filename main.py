...
class VideoPlayerWindow(QMainWindow):
	...
	def createUI(self):
		...
		self.stopbutton.setIcon(QIcon('icons/stopIcon.svg'))
		...
		self.prevbutton.setIcon(QIcon('icons/backwardIcon.svg'))
		...
		self.nextbutton.setIcon(QIcon('icons/forwardIcon.svg'))
